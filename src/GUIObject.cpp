...
const Uint8 GUIObject::_DEFAULT_BACKGROUND_COLOR_R_{0xCC};
const Uint8 GUIObject::_DEFAULT_BACKGROUND_COLOR_G_{0xCC};
const Uint8 GUIObject::_DEFAULT_BACKGROUND_COLOR_B_{0xCC};
